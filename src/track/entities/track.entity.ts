...
export class Track {
    ...
    private constructor(name: string, duration: number, artistId: string|null, albumId: string|null) {
        this._id = uuidv4();
        this._name = name;
    ...
    static create(name: string, duration: number, artistId: string|null, albumId: string|null) {
